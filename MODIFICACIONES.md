...
| `intermedio` | 30 segundos | 240 segundos | 4 minutos |
| `avanzado` | 40 segundos | 300 segundos | 5 minutos |
...
55:     intermedio: { numeroPalabras: 4, puntosPorPalabra: 15, tiempoPorPalabra: 240 },
56:     avanzado: { numeroPalabras: 5, puntosPorPalabra: 20, tiempoPorPalabra: 300 },
57:   } as const;
```